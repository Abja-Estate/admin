import { ChevronLeftIcon, ChevronRightIcon, ExpandMoreIcon, MoreVertIcon, SearchIcon } from "@/components/svgs";
    ...
    return (
        <div className="flex gap-[27px]">
            <div className="flex-1 bg-white rounded-[5px] py-[10px] px-[5px]">
                ...
                <div className="bg-[#F6F8F6] h-[38px] border-t-[6px] border-b-[4px] border-t-[#d4dbd3] border-b-[#d4dbd3] grid grid-cols-[12px">
    ...
    return (
        <div className="w-[253px]">
            ...
            <div className="bg-white py-[4px] px-[8px]">
                <MessageOverview img="/images/message-profile-img-1.svg" username="Susan" />
                <MessageOverview img="/images/message-profile-img-2.svg" username="Akello" />
                <MessageOverview img="/images/message-profile-img-3.svg" username="Bryan" />
                <MessageOverview img="/images/message-profile-img-4.svg" username="Mike" />
                <MessageOverview img="/images/message-profile-img-4.svg" username="Mike" />
            </div>
        </div>
    )
    ...
    return (
        <div className="flex gap-[11px] p-[4px]">
            ...
            <div>
                ...
                <p className="text-[#949494] text-[12px]">Hello, tell me about the progress of the task?</p>
            </div>
        </div>
    )
}
    ...
    return (
        <div className="flex gap-[23px]">
            <div className="w-[562px]">
                ...
                <div>
                    <Button className="!text-[14px] !h-[35px]">
                        See All Payments
                    </Button>
                </div>
            </div>
            <div className="px-[20px] py-[13px] bg-white rounded-[15px] flex flex-col gap-[12px] flex-1">
                <div className="flex justify-between">
                    <div className="flex gap-[8px]">
                        ...
                        />
                        <div>
                            <h1 className="text-[14px] font-semibold text-[#333436]">Reviews</h1>
                            <p className="text-[#949494] text-[10px]">Feedback provided by clients and service providers</p>
                        </div>
                    </div>
                    <div>
                        <CancelIcon />
    ...
    return (
        <div className="flex items-center gap-[5px]">
            <div className="flex-1 h-[7px] bg-[#EDF2F7] rounded-[29px] overflow-hidden">
                <div style={{ width: percent }} className="h-[7px] bg-[#FFD600] rounded-[29px]"></div>
            </div>

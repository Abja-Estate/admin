            ...
            <div className="flex flex-col gap-[24px]">
                {
                    adminSideNavigationLinksData.map((link, i) => {
                        ...
                        const navItem = link.href === "/dashboard" ? (
                            <Link key={i} href={link.href}>
                                ...
                                >
                                    <link.leading className={isDashboardActiveRoute ? "fill-white" : "fill-primary"} />
                            ...
                            <Link key={i} href={link.href}>
                                ...
                                >
                                    <link.leading className={isActiveRoute ? "stroke-white" : "stroke-primary"} />
                                    <span>{link.linkText}</span>
                                </div>
                            </Link>
                        )

...
import { ExpandMoreIcon, MessageIcon, MicIcon, NotificationIcon, SearchIcon } from "../svgs";
            ...
            <div className="flex items-center gap-[114px]">
                <div>
                    <div className="h-[40px] rounded-[10px] bg-[#EAEDE9] w-[500px] border-[1px] border-[#3A3A3A] px-[16px] flex items-center gap-[16px]">
                        <SearchIcon />
                        <input className="w-full flex-1 bg-transparent placeholder-[#3A3A3A] outline-none" placeholder="Search" />
                        <MicIcon />
                    </div>
                </div>
                <div className="flex items-center gap-[16px]">
                    <div className="h-[38px] w-[38px] bg-[#2A4C2333] rounded-[100%] relative grid place-items-center">
                        <NotificationIcon />
                        <span className="absolute h-[12px] w-[12px] grid place-items-center bg-[#D90001] text-white text-[7px] font-semibold rounded-[100%] top-[6px] right-[8px]">8</span>
                    </div>
                    <div className="h-[38px] w-[38px] bg-[#2A4C2333] rounded-[100%] relative grid place-items-center">
                        <MessageIcon />
                        <span className="absolute h-[12px] w-[12px] grid place-items-center bg-[#D90001] text-white text-[7px] font-semibold rounded-[100%] top-[6px] right-[8px]">4</span>
                    </div>

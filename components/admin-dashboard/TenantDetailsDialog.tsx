...
import placeholder from "/public/images/tenant-emoji.svg"
          ...
          <div className="grid gap-3 w-[80vw] md:grid-cols-2 max-w-[57rem]">
            <div className="bg-white p-4 max-h-[55vh] overflow-auto rounded-xl">
              <div className="flex gap-[20px] border-b pb-4 mb-4 border-primaryFade">
                <Image
                  src={tenant.selfie ?? "/images/tenant-profile-img.svg"}
                  alt="Tenant Profile"
                  width={100}
                  className="w-24 h-24 min-w-24 object-cover rounded-full"
                  height={100}
                />
                <div className="py-[8px] w-full">
                  <h1 className="text-textcolor100 capitalize font-semibold mb-[10px]">
                ...
                <div className="flex mt-1 gap-5 flex-wrap">
                  {[
                    ...
                    <div key={i + "feat"} className=" flex flex-col gap-1">
                      ...
                      <span className="text-xs mt-auto block">
                        {each.label}
                      </span>
                    </div>
                  ))}

...
import { CalenderIcon, CalenderOutlineIcon, CancelIcon, ChevronLeftIcon, ChevronLeftIconIcon, ChevronRightGreenIcon, ChevronRightIcon, DeleteRedIcon, MoreVertIcon, SearchIcon, ShareIcon, ShareYellowIcon, StarIcon } from '@/components/svgs';

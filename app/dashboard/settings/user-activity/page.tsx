    ...
    return (
        <div className="p-[40px] rounded-[10px] border-[1px] border-[#7F947B] bg-white w-full max-w-[940px] flex flex-col gap-[40px]">
            <header className="flex items-center justify-between pb-[16px] border-b-[1px] border-b-[#2A4C23]">
                <div>
                    <h1 className="text-[333436] text-[24px] font-semibold mb-[8px]">Users Activity</h1>
        ...
        <div>
            <header className="flex gap-5 items-center mb-[24px] px-[16px]">
                <div className="flex-1">
                    ...
                    <p className="text-[#00000066] font-semibold">Get access to organize users, grant access and remove users.</p>
                </div>
                <div>
                    <button className="text-primary bg-transparent border-[1px] border-primary w-[160px] h-[41px] rounded-[8px] font-semibold">Cancel</button>
                </div>
            </header>
            <div className="flex flex-col p-[16px]">
                <div className="px-[20px] py-[10px] flex justify-between items-center">
                    <figure className="flex gap-[6px] items-center">
                        <Image src="/images/user-activity-admin-1.svg" alt="User Admin" width={48} height={48} />
                        <figcaption className="text-[#333436] text-[14px]">Erica Daniels</figcaption>
                    </figure>
                ...
                <div className="px-[20px] py-[10px] flex justify-between items-center">
                    <figure className="flex gap-[6px] items-center">
                        <Image src="/images/user-activity-admin-2.svg" alt="User Admin" width={48} height={48} />
                        <figcaption className="text-[#333436] text-[14px]">Erica Daniels</figcaption>
                    </figure>
                ...
                <div className="px-[20px] py-[10px] flex justify-between items-center">
                    <figure className="flex gap-[6px] items-center">
                        <Image src="/images/user-activity-admin-3.svg" alt="User Admin" width={48} height={48} />
                        <figcaption className="text-[#333436] text-[14px]">Erica Daniels</figcaption>
                    </figure>
            ...
            <div className="flex justify-end pb-[16px]">
                <button className="text-white bg-primary text-[14px] w-[106px] h-[39px] rounded-[10px]">See More</button>
            </div>
        </div>
    )
}
    ...
    return (
        <div className="border-t-[1px] border-t-primary pt-[12px]">
            <header className="flex gap-5 items-center mb-[24px] px-[16px]">
                ...
                <div>
                    <button className="text-primary bg-transparent border-[1px] border-primary w-[160px] h-[41px] rounded-[8px] font-semibold">Invite</button>
                </div>
            </header>
            <div className="flex flex-col p-[16px]">
                <div className="px-[20px] py-[10px] flex justify-between items-center">
    ...
    return (
        <div>
            <header className="mb-[24px] px-[16px]">
                ...
                <p className="text-[#00000066] font-semibold">Users yet to make confirmation from their mail-box.</p>
            </header>
            <div className="flex flex-col p-[16px]">
                <div className="px-[16px] pt-[24px] pb-[12px] grid grid-cols-3 items-center">
                    ...
                    <div className="flex justify-end">
                        <div className="my-auto flex gap-[16px] items-center">
                            <button className="text-[#949494] bg-transparent border-[1px] border-[#949494] text-[14px] w-[106px] h-[39px] rounded-[8px]">Cancel</button>
                            <button className="text-white bg-primary text-[14px] w-[106px] h-[39px] rounded-[10px]">Recend Invite</button>
                        </div>
                    </div>
                </div>

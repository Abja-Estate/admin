...
import { ArrowGrowthIcon, CalenderOutlineIcon, CancelIcon, CashBillIcon, ChevronLeftIconIcon, ChevronRightGreenIcon, DeleteRedIcon, MoreVertIcon, SearchIcon, ShareIcon, ShareYellowIcon, StarIcon } from "@/components/svgs";
    ...
    <>
      <header className='flex gap-[30px]'>
        <div className="px-[26px] py-[13px] bg-white w-[408px] h-[308px] bg-[url('/images/report-stripes.svg')] rounded-[20px] flex flex-col gap-[12px]">
          ...
          <div className="flex mb-[28px]">
            ...
            <p className="text-[#47893F] text-[12px] mt-[22px] ml-[2px]">Total Payments</p>
          </div>
          <div>
            ...
            <div className="flex justify-between">
              <div className="flex gap-[5px]">
                <h1 className="text-[#333436] text-[22px] font-semibold">$105,090</h1>
                <div className="flex items-center gap-[5px]">
                  <ArrowGrowthIcon />
                  <p className="text-[#333436] text-[14px] font-semibold">17%</p>
                </div>
              </div>
              <p className="text-[14px] text-[#47893F] mt-[5px]">Last Year: 2023</p>
            </div>
          </div>
          <div>
            <div className="mb-[12px]">
            ...
            <div className="flex justify-between">
              <div className="flex gap-[5px]">
                ...
                <div className="flex items-center gap-[5px]">
                  <ArrowGrowthIcon />
                  <p className="text-[#333436] text-[14px] font-semibold">24%</p>
                </div>
              </div>
              <p className="text-[14px] text-[#47893F] mt-[5px]">This Year: 2024</p>
            </div>
          </div>
        </div>
        <div className="w-[724px] h-[308px] rounded-[20px] bg-white px-[24px]">
      ...
      <div className='w-full flex justify-between py-[12px] px-[32px] bg-white mt-[30px]'>
        <div className='items-center flex gap-5'>
          <p className='text-[#47893F] font-semibold border-b-[1px] border-b-[#47893F]'>Service Request Payments</p>
          <p className='text-[#949494] font-semibold border-b-[1px] border-b-[#949494]'>Tenancy Payments</p>
        </div>
        <button className="px-[8px] py-[4px] text-[14px] flex gap-[8px] items-center bg-[#B5D0B2] text-[#47893F] rounded-[4px]">
          <ShareIcon />
          Export
      ...
      <div className='mt-[30px] text-[14px]'>
        ...
        <div className='flex flex-col gap-2'>
          {[...Array(10)].map((_, i) => (
            <div key={i} className='bg-white w-full p-[10px] items-center gap-[20px] grid grid-cols-[20px_1.2fr_1.2fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr] mb-2'>
              <div>
              ...
              <div>
                <div className='flex items-center gap-[5px] mb-[2px]'>
                  <Image src="/images/tenant-emoji.svg" alt="Landlord Emoji" width={24} height={24} />
              ...
              <p>1391234</p>
              <p>$600.45</p>
              <div className="bg-[#B5D0B2] rounded-[8px] px-[8px] py-[4px] flex gap-[8px] items-center"><span className="h-[4px] w-[4px] bg-[#47893F] rounded-[100%]"></span><p className="text-[10px] text-[#47893F]">Tenancy</p></div>
              <p>20 OCT, 2023</p>
              <p>19 OCT, 2024</p>

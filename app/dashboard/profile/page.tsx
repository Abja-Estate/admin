        ...
        <div className="flex gap-[32px]">
            <div className="w-[315px] flex flex-col rounded-se-[100px] bg-white">
                <div className="p-[24px] h-[300px] border-b-[1px] border-b-[#47893F] w-full">
                    <figure>
                        <Image src='/images/admin-user-img-1.svg' width={100} height={100} alt="Admin" />
                        <figcaption className='text-[#333436] text-[18px] font-semibold pt-5'>Micheal Ibaro</figcaption>
                    </figure>
                ...
                <div className='flex flex-col px-[24px] py-[24px] h-[500px] gap-10 h-[35]'>
                    <div>
                        ...
                        <p className='text-[#949494]'>Super Admin of Abja Property Management Admin Dashboard, has 10+ years of experience in the industry. He oversees the entire operation of the dashboard, including managing user accounts, setting up permissions, and resolving technical issues. Michael is passionate about helping property owners and is always available to assist users.</p>
                    </div>
            ...
            <div className='rounded-tl-[100px] w-[900px] overflow-hidden'>
                <header className='h-[300px] flex flex-col justify-between w-full bg-[url(/images/profile-cover-img.svg)] bg-cover py-10 px-[24px]'>
                    <div className='pt-5 flex items-center justify-between'>
                        <h1 className='text-[28px] text-[#333436] font-semibold'>Good Morning Micheal,</h1>
                ...
                <div className='h-[500px] w-full p-[24px] bg-white'>
                    <div className='flex items-center justify-between mb-[24px]'>
                        <h1 className='text-[18px] text-[#333436] font-semibold'>Recent Activity Log</h1>

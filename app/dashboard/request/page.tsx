import { AddGreenIcon, ArrowGrowthIcon, ArrowGrowthWhiteIcon, CalenderOutlineIcon, ChevronLeftIconIcon, ChevronRightGreenIcon, DeleteRedIcon, DoubleCheckWhiteIcon, FilterGreenIcon, InformationIcon, MoreVertIcon, NotificationOutlineWhiteIcon, ProgressiveClockWhiteIcon, RequestIcon, SearchIcon, ShareIcon, ShareYellowIcon, TagIcon, TaskCompleteWhiteIcon } from "@/components/svgs";
        ...
        <>
            ...
            <div className='mt-[30px] text-[14px]'>
                ...
                <div className='flex flex-col gap-2'>
                    {[...Array(10)].map((_, i) => (
                        <div key={i} className='bg-white w-full p-[10px] gap-[20px] grid grid-cols-[20px_60px_1.2fr_1fr_1fr_1.4fr_0.8fr_0.9fr_1fr_0.82fr] mb-2'>
                            <div>
                            ...
                            <div>
                                <div className='flex items-center gap-[5px] mb-[2px]'>
                                    <Image src="/images/tenant-emoji.svg" alt="Service Personnel Emoji" width={24} height={24} />

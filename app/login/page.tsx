    ...
    return (
        <div className="flex">
            <figure className="relative basis-[35%]">
                <Image src={authImage3} alt="House" className="w-full h-full object-cover" />
                <button onClick={backwardNavigate} className="w-[40px] h-[40px] rounded-[100%] bg-white grid place-items-center top-[50px] left-[50px] absolute">
                    <ArrowLeftIcon />
                </button>
            </figure>
            <div className="basis-[65%] bg-white relative pt-[24px]">
                <Image src={authImage1} alt="House" className="absolute top-0 left-0 pointer-events-none" />
                <Image src={authImage2} alt="House" className="absolute top-0 right-0 pointer-events-none" />
                <div className="px-[24px] pb-[230px]">
                    <header className="grid place-items-center gap-[24px] pb-[32px]">
                        ...
                        <p className="text-[#333436] font-semibold">Fill in the details below to login into your Abja Property Management account. </p>
                    </header>
                    <form className="flex flex-col gap-[32px] w-full max-w-[500px] mx-auto" onSubmit={submit}>
                        <fieldset>
                            <label className="inline-block text-primary font-medium mb-[16px]">Email or Phone number</label>
                            <Input
                                type="email"
                                name="email"
                        ...
                        <fieldset>
                            <label className="inline-block text-primary font-medium mb-[16px]">Password</label>
                            <Input
                                type="password"
                                name="password"
                        ...
                        <fieldset className="pt-[18px] text-center">
                            <p>Forgot Password?&nbsp;
                                <Link href='/admin/reset-password'><span className="text-[#0174C7]">Tap Here</span></Link>
                            </p>
                        </fieldset>
